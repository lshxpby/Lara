...
const Footer = () => {
  return (
    <Container>
        <Left>
            <Logo>L A R A </Logo>
            <Desc>LARA is a home-grown fashion brand, designed and curated with an impeccible sense of style. Discover your sense of style with us.</Desc>
            <SocialContainer>
        ...
        <Right>
            ...
            <ContactItem><Room style={{marginRight:"10px"}} />
                4th Main Cross Road, Indiranagar, Bangalore
            </ContactItem>
